        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-8 md:mb-12">
            <div className="flex items-center mb-4 md:mb-6">
              ...
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>Editeur du site</h2>
            </div>
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm md:text-base" style={{ color: "#f7f3e9" }}>E-mail : </span>
                <a 
              ...
              <div className="flex items-center space-x-2 mt-2">
                ...
                <span className="text-sm md:text-base" style={{ color: "#f7f3e9" }}>Téléphone : </span>
                <span className="font-medium text-sm md:text-base" style={{ color: '#f7f3e9' }}>+33 6 37 58 18 86</span>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8 md:mb-12">
            <div className="flex items-center mb-4 md:mb-6">
              ...
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>Hébergement</h2>
            </div>
          ...
          <section className="mb-8 md:mb-12">
            <div className="flex items-center mb-4 md:mb-6">
              ...
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>Propriété intellectuelle</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 md:p-6 rounded-xl">
                <p className="text-sm md:text-base mb-3 md:mb-4" style={{ color: '#f7f3e9' }}>
          ...
          <section className="mb-8 md:mb-12">
            <div className="flex items-center mb-4 md:mb-6">
              <Users className="w-6 h-6 mr-3" style={{ color: "#f7f3e9" }} />
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>
            ...
            <div className="space-y-4 md:space-y-6">
              <div>
                ...
                <div className="p-4 md:p-6 rounded-xl space-y-3 md:space-y-4">
                  <p className="text-sm md:text-base" style={{ color: '#f7f3e9' }}>
          ...
          {/* Marques et logos */}
          <section className="mb-8 md:mb-12">
            <h2 className="text-xl md:text-2xl font-semibold mb-4 md:mb-6" style={{ color: '#f7f3e9' }}>
          ...
          <section className="mb-8 md:mb-12">
            ...
            <div className="grid gap-4 md:gap-6">
              ...
              <div 
                ...
                style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
              >
                <h3 className="text-lg font-semibold mb-2 md:mb-3" style={{ color: "#f7f3e9" }}>Commentaires</h3>
                <p className="text-sm md:text-base" style={{ color: '#f7f3e9' }}>
              ...
              <div 
                ...
                style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
              >
                <h3 className="text-lg font-semibold mb-2 md:mb-3" style={{ color: "#f7f3e9" }}>Formulaires de contact</h3>
                <p className="text-sm md:text-base" style={{ color: '#f7f3e9' }}>
              ...
              <div 
                ...
                style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
              >
                <h3 className="text-lg font-semibold mb-2 md:mb-3" style={{ color: "#f7f3e9" }}>Cookies</h3>
                <p className="text-sm md:text-base mb-3" style={{ color: '#f7f3e9' }}>
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            <section>
              <h2 className="text-lg md:text-xl font-semibold mb-3 md:mb-4" style={{ color: '#f7f3e9' }}>
