        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-center mb-4">
              <FileText className="w-6 h-6 mr-3" style={{ color: '#f7f3e9' }} />
              <h2 className="text-lg md:text-xl font-semibold" style={{ color: '#f7f3e9' }}>À propos de cette politique</h2>
            </div>
            ...
            <p className="mb-4 text-sm md:text-base" style={{ color: '#f7f3e9' }}>
              ...
              <a href="https://www.jazzentech.com" className="font-medium hover:underline mx-1" style={{ color: '#f7f3e9' }}>
          ...
          <section className="mb-8 md:mb-12">
            <div className="flex items-center mb-4 md:mb-6">
              <Database className="w-6 h-6 mr-3" style={{ color: '#f7f3e9' }} />
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>Définitions</h2>
            </div>
            ...
            <div className="p-4 md:p-6 rounded-xl space-y-4">
              <div 
                ...
                style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
              >
                <h3 className="font-semibold mb-2 text-sm md:text-base" style={{ color: '#f7f3e9' }}>Service</h3>
                <p className="text-xs md:text-sm" style={{ color: '#f7f3e9' }}>
              ...
              <div 
                ...
                style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
              >
                <h4 className="font-semibold mb-2 text-sm md:text-base" style={{ color: '#f7f3e9' }}>Données à caractère personnel</h4>
                <p className="text-xs md:text-sm" style={{ color: '#f7f3e9' }}>
              ...
              <div 
                ...
                style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
              >
                <h4 className="font-semibold mb-2 text-sm md:text-base" style={{ color: '#f7f3e9' }}>Données d'Utilisation</h4>
                <p className="text-xs md:text-sm" style={{ color: '#f7f3e9' }}>
              ...
              <div 
                ...
                style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
              >
                <h4 className="font-semibold mb-2 text-sm md:text-base" style={{ color: '#f7f3e9' }}>Cookies</h4>
                <p className="text-xs md:text-sm" style={{ color: '#f7f3e9' }}>
          ...
          <section className="mb-8 md:mb-12">
            <div className="flex items-center mb-4 md:mb-6">
              <Eye className="w-6 h-6 mr-3" style={{ color: '#f7f3e9' }} />
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>Collecte et utilisation des données</h2>
            </div>
            
            <div className="space-y-6 md:space-y-8">
              {/* Données à Caractère Personnel */}
              <div className=" rounded-xl p-4 md:p-6 shadow-sm">
                <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4" style={{ color: '#f7f3e9' }}>
                  Données à Caractère Personnel
                </h3>
                <p className="mb-4 text-sm md:text-base" style={{ color: '#f7f3e9' }}>
                ...
                <div className="grid sm:grid-cols-3 gap-3 md:gap-4">
                  <div 
                    ...
                    style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
                  >
                    <Mail className="w-5 h-5 mx-auto mb-2" style={{ color: '#f7f3e9' }} />
                    <p className="text-xs md:text-sm font-medium" style={{ color: '#f7f3e9' }}>Adresse e-mail</p>
                  </div>
                  <div 
                    className="p-3 rounded-lg text-center"
                    style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
                  >
                    <Users className="w-5 h-5 mx-auto mb-2" style={{ color: '#f7f3e9' }} />
                    <p className="text-xs md:text-sm font-medium" style={{ color: '#f7f3e9' }}>Nom et prénom</p>
                  </div>
                  <div 
                    className="p-3 rounded-lg text-center"
                    style={{ backgroundColor: 'rgba(26, 26, 26, 0.5)', border: '1px solid rgba(212, 175, 55, 0.3)' }}
                  >
                    <Settings className="w-5 h-5 mx-auto mb-2" style={{ color: '#f7f3e9' }} />
                    <p className="text-xs md:text-sm font-medium" style={{ color: '#f7f3e9' }}>Cookies & Usage</p>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-8 md:mb-12">
            <div className="flex items-center mb-4 md:mb-6">
              ...
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>Utilisation des données</h2>
            </div>
            ...
            <div className=" rounded-xl p-4 md:p-6 shadow-sm">
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  ...
                  ></div>
                  <span className="text-sm md:text-base" style={{ color: '#f7f3e9' }}>
          ...
          <section className="mb-8 md:mb-12">
            <div className="flex items-center mb-4 md:mb-6">
              ...
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>Droits RGPD</h2>
            </div>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-3 md:gap-4">
                <div className="p-3 rounded-lg">
                  <h3 className="font-semibold text-xs md:text-sm mb-1" style={{ color: '#f7f3e9' }}>
                    Droit d'accès
                  </h3>
                  <p className="text-xs text-stone-300">Aux informations que nous détenons</p>
                </div>
                
                <div className="p-3 rounded-lg">
                  <h4 className="font-semibold text-xs md:text-sm mb-1" style={{ color: '#f7f3e9' }}>
                    Droit de rectification
                  </h4>
                  <p className="text-xs text-stone-300">Modifier vos données inexactes</p>
                </div>
                ...
                <div className="p-3 rounded-lg">
                  ...
                  <p className="text-xs text-stone-300">Vous opposer au traitement</p>
                </div>
                ...
                <div className="p-3 rounded-lg">
                  ...
                  <p className="text-xs text-stone-300">Limiter le traitement</p>
                </div>
                ...
                <div className="p-3 rounded-lg">
                  ...
                  <p className="text-xs text-stone-300">Récupérer vos données</p>
                </div>
                ...
                <div className="p-3 rounded-lg">
                  ...
                  <p className="text-xs text-stone-300">Retirer votre consentement</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8 md:mb-12">
            <div className="flex items-center mb-4 md:mb-6">
              <Lock className="w-6 h-6 mr-3" style={{ color: '#f7f3e9' }} />
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>Sécurité des données</h2>
            </div>
            ...
            >
              <div className="flex items-start">
                <AlertTriangle className="w-5 h-5 mt-0.5 mr-3 flex-shrink-0" style={{ color: '#f7f3e9' }} />
                <p className="text-sm md:text-base" style={{ color: '#f7f3e9' }}>
          ...
          <section>
            <div className="flex items-center mb-4 md:mb-6">
              ...
              <h2 className="text-xl md:text-2xl font-semibold" style={{ color: '#f7f3e9' }}>Nous contacter</h2>
            </div>
